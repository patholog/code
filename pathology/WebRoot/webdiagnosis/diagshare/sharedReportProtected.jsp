                  ...
                  <div class="inbox_content mlrAuto">
                    <div class="inbox_con_list">
                      ...
                      <div class="pl_number border_bom">
                        ...
                        <a style=" float:right">会诊号：<span id="lblCheckNumber">
                          <input id="caseId" name="caseId" value="" readonly>
                        </span></a>
                      </div>
                      <div class="report_list border_bom">
                        <ul>
                          ...
                          <li style="width: 30%">
                            <label>送检时间：</label>
                            <span id="lblDateOfDelivery"></span>
                          </li>
                          <li class="half">
                            <label>送检单位：</label>
                    ...
                    <div class="inbox_con_list">
                      ...
                      <div class="inbox_list border_bom" id="divGeneralObservation">
                        <textarea id="generalSee" name="generalSee" cols="10" rows="1" class="ckeditor"></textarea>
                      </div>
                    </div>
                    <div class="inbox_con_list">
                      <div class="report_title">
                    ...
                    <div class="inbox_con_list">
                      <div class="inbox_title">
                        <div class="left">本报告由
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;专家会诊
                          <p></p></div>
                        <div class="right">专家签字：<span id="lblUserName"></span>
                        </div>
                      </div>
                    </div>
                    <div class="inbox_con_list">
                      <div class="message right">
                        <input type="hidden" id="btnSaveContent" class="inf_btn massges_btn" value="保存">
                      </div>
                    </div>
                  </div>
                </div>
...
<div id="reopenModal" style="width: 400px; height: 200px;">
    <div id="open">
      <form id="reopenForm" action="ShareAction!shared" method="post">
        <div>
       	  <input type="hidden" id="sid" name="sid"/>
          <label>请输入密码继续访问</label>
          <textarea id="pwd" name="pwd" rows="3" style="width: 100%;margin-top: 5px;"></textarea>
        </div>
        <div style="margin-top: 5px;">
          <input id="reopenBtn" type="button" class="ui-button" value="确定"/>
        </div>
      </form>
    </div>
</div>
...
<script>
  $(function () {
    ...
    $('#reopenBtn').click(function() {
      window.location.href="ShareAction!shared?sid=" + $('#sid').val() + "&pwd=" + $('#pwd').val();
    });
