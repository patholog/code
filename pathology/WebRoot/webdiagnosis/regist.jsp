								...
								.blur(
										function() {
											...
											if (email == '') {
												$("#emailtip")
														.html(
																"<a style='color:#2ca9cc;font-size:14px;'>邮箱不能为空！</a>");
												$("#btn")
														.attr("disabled", true);
												return false;
											} else {
												...
												$
														.ajax({
															...
															error : function(d) {
																$("#emailtip")
																		.html(
																				"<a style='color:#2ca9cc;font-size:14px;'>邮箱已注册!</a>");
																$("#btn")
																		.attr(
																				"disabled",
																				true);
								...
								.blur(
										function() {
											...
											if (pswd == pswd2) {
												...
												$("#pwsd2tip")
														.html(
																"<a style='color:#2ca9cc;font-size:14px;'>两次密码输入不一致!</a>");
												$("#btn")
														.attr("disabled", true);
								...
								.blur(
										function() {
											...
											if (name != ""
												...
												$("#nametip")
														.html(
																"<a style='color:#2ca9cc;font-size:14px;'>只能输入字母或数字!</a>");
												$("#username").val("");
												$("#btn")
														.attr("disabled", true);
												return false;
					...
					<td>
						<table id="registertable" border="0px" align="center" border="0px"
							...
							<tr>
								...
								<td align="left"><input id="x_txt_test" type="text"
									placeholder="demo" /> <span id="x_tip_test_tip"></span>
								</td>
							</tr>
							<tr>
							...
							<tr height="60px">
								<td align="center"><input type="submit" accesskey="enter"
									...
									formmethod="post" /><input type='button' value="demo" id="x_btn_demo"/>
								</td>
								<td align="center"><input type="button" value="已注册"
