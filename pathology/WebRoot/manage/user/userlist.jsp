...
<table id="main" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <td id="contents"><table id="pagehead" cellspacing="0" cellpadding="0" width="100%"
					border="0">
        <tr>
          <td><h1>用户管理</h1></td>
        </tr>
          ...
          <c:forEach items="${sessionScope.list }" var="user"
            ...
            <tr bgColor="${status.index%2==0?'#f9f9ff':'#ffffff' }">
              ...
              <td class="action_collomn"><a
									href="UserAction!updateUser?user.idUsers=${user.idUsers}">修改</a> &nbsp; | &nbsp; <a
          ...
          <tr class="lightrow">
            <td colspan="8"><div id="pageDir">
                ...
                <!-- 
						...
						-->
                <c:forEach var="i" begin="1" step="1" end="${lastIndex }"> <a href="UserAction!userList?index=${i } " target="mainFrame">
                  <c:out
												value="${i }" />
                  </a> </c:forEach>
                ...
                <s:form action="UserAction!userList" theme="simple"
										target="mainFrame"> 第&nbsp;
                  <s:textfield name="index" cssStyle="width:25px;height:20px;" />
                  &nbsp;页&nbsp; &nbsp;
