...
<div id="header">
	...
	<table id="main" cellpadding="0" cellspacing="0" border="0">
		<tr>
		  ...
		  <form name="articles" id="articles" method="post" action="RolesAction!addRoles">
		    <table class="maintable form_top_thin">
              <tr>
                <th>角色名称</th>
                <td><input type="text" name="roles.name" id="title" value="" style="width:300px;" /> </td>
              </tr>			  
              <tr>
                <th>角色描述</th>
                <td><input type="text" name="roles.description" id="title" value="" style="width:300px;" /> </td>
              </tr>			  
              <tr>
                <th>角色备注</th>
                <td><input type="text" name="roles.memo" id="title" value="" style="width:300px;" /> </td>
              </tr>			  
              <tr>
