					...
					<tbody>
						...
						<c:forEach items="${sessionScope.roleslist }" var="roles" varStatus="status">
							...
							<td>${roles.memo }</td>
								<td class="action_collomn"><a
									...
									href="RolesAction!deleteRoles?roles.idRoles=${roles.idRoles }">删除</a>
							</tr>
						</c:forEach>
						...
						<tr class="lightrow">
							<td colspan="8"><div id="pageDir">
									...
									第${sessionScope.thisindex }/${lastIndex }页 &nbsp; &nbsp; <a
										href="RolesAction!rolesList?index=1" target="mainFrame">首页</a>&nbsp; 
									<!-- 
						...
						-->
									<c:forEach var="i" begin="1" step="1" end="${lastIndex }">
										<a href="RolesAction!rolesList?index=${i } " target="mainFrame"><c:out
												value="${i }" /> </a>
									</c:forEach>
									&nbsp;<a href="RolesAction?index=${lastIndex}" target="mainFrame">尾页</a>
