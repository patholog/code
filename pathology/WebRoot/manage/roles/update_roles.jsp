...
<div id="header">
	...
	<table id="main" cellpadding="0" cellspacing="0" border="0">
		<tr>
		  ...
		  <form name="articles" id="articles" method="post" action="RolesAction!saveRoles">
		    <table class="maintable form_top_thin">
              ...
              <tr>
                <th>角色描述</th>
                <td><input type="text" name="roles.description" id="title" value="${sessionScope.roles.description}" style="width:300px;" /> </td>
              </tr>			  
              <tr>
                <th>角色备注</th>
                <td><input type="text" name="roles.memo" id="title" value="${sessionScope.roles.memo}" style="width:300px;" /></td>
              </tr>	
            </table>
