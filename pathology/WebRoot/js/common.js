...
function maxLenCheck(obj,maxlen,strObjName) // True or False
{
	...
	if( len > maxlen )
	{
		alert(strObjName+" is too long in "+len+"! The max length is "+maxlen+".");
		// obj.focus();
		return false;
	}
	return true;
...
function isNumeric(obj,strObjName)  // True or False
{
	...
	if(obj.value.match(regExp)) {
		...
		alert(strObjName+" is not numeric value! Only 0-9 digits allowed.");
		// obj.value = '';
		// obj.focus();
		return false;
	}
...
function isLetter(obj,strObjName)  // True or False
{
	...
	if(obj.value.match(regExp)) {
		...
		alert(strObjName+" is not letters value! Only a-zA-Z letters allowed.");
		// obj.value = '';
		// obj.focus();
		return false;
	}
...
function checkDate(obj,strObjName)
{
	...
	if(obj.value.match(dateExp)) {
		...
		alert(strObjName+" is not date formated!");
		// obj.focus();
		return false;
	}
}
...
function isFloat(obj,strObjName)
{
	...
	if(obj.value.match(floatExp)) {
		...
		alert(strObjName+" is not float value!");
		// obj.focus();
		return false;
	}
}
...
function isInt(obj,strObjName)
{
	...
	if(obj.value.match(regExp)) {
		...
		alert(strObjName+" is not integer value.");
		// obj.focus();
		return false;
	}
}
...
function filterBrand(str,brand)
{
	if(brand.Trim()!='')
	{
		str = str.replace('/'+brand+'\s+'+'/i','');
		str = str.replace('/'+'\s+'+brand+'/i','');
