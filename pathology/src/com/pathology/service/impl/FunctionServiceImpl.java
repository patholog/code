...
public class FunctionServiceImpl implements IFunctionService {
	...
	public List<Function> getFunctionList(String id_role)throws Exception{
		String sql = " select f.name,f.url,f.id_function from function  f left join role_function r  on f.id_function = r.id_founction and  r.id_role = '"+id_role+"' order by f.SORT_NO";
